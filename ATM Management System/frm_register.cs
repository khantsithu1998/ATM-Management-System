        ...
        private void btn_submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    String str = "Insert Into accounts_tbl(account_no,full_name,mobile_no,address,pin,education,occupation,dob,amount)Values('" + txt_accountno.Text + "','" + txt_yourname.Text + "','" + txt_mobailno.Text + "','" + txt_address.Text + "','" + txt_pin.Text + "','" + txt_education.Text + "','" + txt_occupation.Text + "','" + dtp_dob.Text + "','" + lbl_balance.Text + "')";

                    SqlCommand cmd = new SqlCommand(str, con);

                    cmd.ExecuteNonQuery();

                    String str1 = "Select max(account_no) From accounts_tbl";
