...
namespace ATM_Management_System
{
    public partial class frm_main : Form
    {
        ...
        {
            this.Hide();
            frm_deposit fd = new frm_deposit();
            fd.ShowDialog();
        }
        ...
        {
            this.Hide();
            frm_transaction ft = new frm_transaction();
            ft.ShowDialog();
        }
        ...
        private void loadaccount()
        {
            try
            {
                ...
                cmd.CommandText = "select full_name,dob From accounts_tbl where account_no = '" + lbl_accountno.Text + "'";
